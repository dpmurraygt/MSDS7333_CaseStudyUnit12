...
mcTrialOutput = MCBA(params = trialParams, repeats = 50, 
                     mG = 200, mO = 10000)
                     
# save data for later use
save(mcTrialOutput, file = "data/mcTrialOutput1.rda")
```
