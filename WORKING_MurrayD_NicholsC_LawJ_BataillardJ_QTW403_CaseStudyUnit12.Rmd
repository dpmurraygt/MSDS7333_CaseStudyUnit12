...
# VIZ STUFF
# useful for results? put into a grid of boxes
invisible(mapply(function(oneSet, lambda, kappa) {
  ...
  mcOutputK1, lambda = lambdas, kappa = kappas,
  SIMPLIFY = TRUE))
# notice that lambda == 0.2, jobs die off before end
# see if this stays the same when we double and test ratio....
...
invisible(mapply(function(oneSet, lambda, kappa) {
  ...
  mcOutputK2, lambda = lambdas2, kappa = kappas2,
  SIMPLIFY = TRUE))
# yep, ratio prevails. Jobs die out @ 0.4 lambda
# plot it up a bit more and conclude
